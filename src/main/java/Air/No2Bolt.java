...
//                result_step2 = airMap.step2(1,region_n);
    ...
    public void execute(Tuple tuple) {
        ...
        step2_data.setNum((Integer)tuple.getValueByField("region"));
        step2_data.setNum((Integer)tuple.getValueByField("bld"));
        System.out.print("@@@Step 2 Start @@@");
        ...
        if(step2_data.getFlag() == 2) {
            ...
            System.out.println("step 2 Exception:" + e.toString());
        }
